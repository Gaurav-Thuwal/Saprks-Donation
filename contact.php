...
?>
        ...
        <header class="header" style="margin-top: 0px;">
            <div class="heading">
            <h3 style="margin-left: 5px; margin-top: 20px;"><a href="index.php" class="logo">CONTACT US</a></h3></div>
            ...
            <div class="welcome" style="position: relative;">
                <h3 style="color: white; color: aqua;"><br>REACH US ON</h3>
               <a href="https://www.instagram.com/"><img src="./images/insta.jpg" style="height:100px;width:100px"></img></a>
               ...
               <a href="https://www.whatsapp.com"><img src="./images/whatsapp.jpg" style="height:100px;width:100px"></img></a>
            </div>
        </div>
        </header>
