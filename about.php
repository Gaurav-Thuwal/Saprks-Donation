...
<html>
    ...
    <body>
        <header class="header" style="margin-top: 0px;">
            <h3 style="margin-right:10 px; margin-top: 20px;"><a href="about.php" class="logo">ABOUT US</a></h3>
            ...
            <div class="pattern">
                ...
                <p style="color: aqua; text-align: center;"> <br>
                   <b>WE ARE A NON PROFIT TEAM  <br>
                                    AND WORK WORLDWIDE</b><br>
				</p>
				<p style="color: gold; text-align: center;"> <br>
				   Our approach is rooted in years of on-the-ground experience, 
									...
									up in a family. We believe in collaboration as we know this work is bigger than
